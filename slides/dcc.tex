...
\begin{frame}{Updates Summary}
  \begin{itemize}
    \item Previous versions were either unable to express dependent types in an elegant way, or relied on hacky methods resembling dynamic typing.
    \item The latest version leverages the ideas of the assertions / arguments register design, but with explicit type arguments for all the primitive combinators, and with far fewer, and much simpler eval rules.
  \end{itemize}
\end{frame}
