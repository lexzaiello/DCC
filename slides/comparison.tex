...
\begin{frame}{Deriving the Explicit \leane{fst} Combinator}
  \begin{leancode}
/-
...
-/
theorem fst_der (head tail fn : Expr) : IsStep ($ fst, fn, _α, _β, ::[head, tail]) ($ fn, head) ↔
