...
\begin{frame}{Overview}
  \begin{itemize}
    \item The \textit{DCC} achieves dependent typing without variables by interpreting sigma types (i.e., \mintinline{lean4}|s := (fst : \alpha) \times (snd : \beta x)| in Lean) as a future function application.
